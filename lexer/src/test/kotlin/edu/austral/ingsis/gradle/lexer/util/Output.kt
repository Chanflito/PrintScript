...
val output_004 = Token("number", TypeNumber, TokenPosition(Position(1, 10), Position(1, 16)))
...
val output_006 = Token("\"hola\"", ValueString, TokenPosition(Position(1, 19), Position(1, 25)))

val output_007 = Token("19", ValueNumber, TokenPosition(Position(1, 18), Position(1, 20)))
...
val output_009 =
    listOf(
        ...
        Token("string", TypeString, TokenPosition(Position(1, 16), Position(1, 22))),
        Token("=", Assignation, TokenPosition(Position(1, 23), Position(1, 24))),
        Token("+", Plus, TokenPosition(Position(1, 25), Position(1, 26))),
        Token("5", ValueNumber, TokenPosition(Position(1, 27), Position(1, 28))),
        Token("\"let\"", ValueString, TokenPosition(Position(1, 29), Position(1, 34))),
        Token("+", Plus, TokenPosition(Position(1, 35), Position(1, 36))),
        Token("1", ValueNumber, TokenPosition(Position(1, 37), Position(1, 38))),
        Token("+", Plus, TokenPosition(Position(1, 39), Position(1, 40))),
        Token("\"println\"", ValueString, TokenPosition(Position(1, 41), Position(1, 50))),
        Token("+", Plus, TokenPosition(Position(1, 51), Position(1, 52))),
        Token("\"aaalet1\"", ValueString, TokenPosition(Position(1, 53), Position(1, 62))),
...
val output_010 =
    listOf(
        ...
        Token("\"Joe\"", ValueString, TokenPosition(Position(1, 21), Position(1, 26))),
        ...
        Token("string", TypeString, TokenPosition(Position(2, 17), Position(2, 23))),
        Token("=", Assignation, TokenPosition(Position(2, 24), Position(2, 25))),
        Token("\"Doe\"", ValueString, TokenPosition(Position(2, 26), Position(2, 31))),
        ...
        Token("\" \"", ValueString, TokenPosition(Position(3, 17), Position(3, 20))),
...
val output_011 =
    listOf(
        ...
        Token("12", ValueNumber, TokenPosition(Position(1, 17), Position(1, 19))),
        Token(";", SemiColon, TokenPosition(Position(1, 19), Position(1, 20))),
        ...
        Token("4", ValueNumber, TokenPosition(Position(2, 17), Position(2, 18))),
