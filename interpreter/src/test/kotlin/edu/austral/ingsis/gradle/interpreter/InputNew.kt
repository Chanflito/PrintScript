...
val input_001n= ProgramNode(TokenPosition(Position(0, 0), Position(0, 0)), listOf(
    DeclarationAssignation(
        ...
        StringLiteral("hola", TokenPosition(Position(0, 0), Position(0, 0))
    )
)))

val input_002n= ProgramNode(TokenPosition(Position(0, 0), Position(0, 0)), listOf(
    DeclarationAssignation(
        LetKeywordNode(TokenPosition(Position(0, 0), Position(0, 3))),
        TokenPosition(Position(0, 0), Position(0, 20)),
        StringNodeType,
...
val input_003n= ProgramNode(TokenPosition(Position(0, 0), Position(0, 0)), listOf(
    DeclarationAssignation(
        LetKeywordNode(TokenPosition(Position(0, 0), Position(0, 3))),
        TokenPosition(Position(0, 0), Position(0, 20)),
        NumberNodeType,
        IdentifierNode("x", TokenPosition(Position(0, 0), Position(0, 0))),
        NumberLiteralNode(1, TokenPosition(Position(0, 0), Position(0, 0))
    )),
    ReAssignationNode(
        TokenPosition(Position(0, 0), Position(0, 0)),
...
val input_004n= ProgramNode(TokenPosition(Position(0, 0), Position(0, 0)), listOf(
    ReAssignationNode(
        TokenPosition(Position(0, 0), Position(0, 0)),
...
val input_005n= ProgramNode(TokenPosition(Position(0, 0), Position(0, 0)), listOf(
    DeclarationAssignation(
        LetKeywordNode(TokenPosition(Position(0, 0), Position(0, 3))),
        TokenPosition(Position(0, 0), Position(0, 20)),
        NumberNodeType,
...
val input_006n= ProgramNode(TokenPosition(Position(0, 0), Position(0, 0)), listOf(
    DeclarationAssignation(
        LetKeywordNode(TokenPosition(Position(0, 0), Position(0, 3))),
        TokenPosition(Position(0, 0), Position(0, 20)),
        NumberNodeType,
...
val input_007n= ProgramNode(TokenPosition(Position(0, 0), Position(0, 0)), listOf(
    DeclarationAssignation(
...
val input_008n = ProgramNode(
    TokenPosition(Position(0, 0), Position(0, 0)), listOf(
    DeclarationAssignation(
        LetKeywordNode(TokenPosition(Position(0, 0), Position(0, 3))),
        TokenPosition(Position(0, 0), Position(0, 20)),
        BooleanNodeType,
