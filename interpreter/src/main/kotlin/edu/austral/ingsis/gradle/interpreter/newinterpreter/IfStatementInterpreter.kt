...
class IfStatementInterpreter (val node: AST, val context: Context) : Interpreter {override fun interpret(node: AST, context: Context, interpreterManager: InterpreterManager): InterpretResult {
